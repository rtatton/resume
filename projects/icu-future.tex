...
{Biomedical Engineering Senior Capstone Project}{Feb -- May 2021}
	...
	\item Implemented a deep reconstruction classification neural network to predict ICU patient stress in an unsupervised manner using Keras. Source code: \urlhref{https://github.com/rtatton/ebme380}{github.com/rtatton/ebme380}.
\end{ritemize}